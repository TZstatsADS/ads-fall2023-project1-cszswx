...
# Read data
```{r}
hm_data <- read_csv("/Users/jaysun/Downloads/HappyDB-master/happydb/data/cleaned_hm.csv")
demo_data <- read_csv("/Users/jaysun/Downloads/HappyDB-master/happydb/data/demographic.csv")
```
...
```{r}
write_csv(hm_data, "/Users/jaysun/Desktop/R_programming/processed_data.csv")
```
